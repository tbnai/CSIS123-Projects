...
int main()
{
	...
	cout << " Interior volume of finished crate:" << fixed << setprecision(2) << setw(8) << cratevol << endl << endl;
	...
	cout << " Estimated cost of finished crate:" << fixed << setprecision(2) << setw(8) << estimatedCost;
	return 0;
}